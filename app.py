...
<style>
.stApp {
    background-image: url("https://tse1.mm.bing.net/th/id/OIP._tf-dDspbDKFo3AqizoR2wHaEo?pid=Api&P=0&h=180");
...
model_path = "Random_forest_model(2).pkl" if model_option == "Random Forest" else "Linear_model.pkl"
